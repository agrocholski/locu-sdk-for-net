...
namespace SingleVenue.ViewModels
{
    public class VenueViewModel : ViewModelBase
    {
        ...
        public async Task<bool> Save()
        {
            ...
            try
            {
                ...
                var dataFile = await dataFolder.CreateFileAsync("venue.json", Windows.Storage.CreationCollisionOption.ReplaceExisting);
        ...
        public static async Task<VenueViewModel> Create()
        {
            var cachedData = "";
        ...
        private async static Task<string> GetDataFromIsolatedStorage()
        {
            string data = "";
            ...
            try
            {
                var dataFile = await dataFolder.OpenStreamForReadAsync("venue.json");
